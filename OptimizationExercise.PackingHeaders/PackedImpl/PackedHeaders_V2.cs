...
{
    public sealed class PackedHeaders_V2 : IHeadersStructure<PackedHeaders_V2, PackedHeaders_V2.Enumerator>
    {
        public struct Enumerator : IEnumerator<HeaderNames>
        {
            private readonly PackedHeaders_V2 outer;
            ...
            internal Enumerator(PackedHeaders_V2 outer)
            {
                Current = default;
                this.outer = outer;
        ...
        public static PackedHeaders_V2 CreateEmpty()
        => new PackedHeaders_V2();

        public static PackedHeaders_V2 CreateFromDictionary(Dictionary<HeaderNames, string> dict)
        {
