...
{
    public sealed class PackedHeaders_V3 : IHeadersStructure<PackedHeaders_V3, PackedHeaders_V3.Enumerator>
    {
        public struct Enumerator : IEnumerator<HeaderNames>
        {
            private readonly PackedHeaders_V3 outer;
            ...
            internal Enumerator(PackedHeaders_V3 outer)
            {
                Current = default;
                this.outer = outer;
        ...
        public static PackedHeaders_V3 CreateEmpty()
        => new PackedHeaders_V3();

        public static PackedHeaders_V3 CreateFromDictionary(Dictionary<HeaderNames, string> dict)
        {
