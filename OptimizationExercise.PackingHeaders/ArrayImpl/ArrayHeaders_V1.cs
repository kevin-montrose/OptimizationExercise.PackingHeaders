...
namespace OptimizationExercise.PackingHeaders.ArrayImpl
{
    ...
    /// </summary>
    public sealed class ArrayHeaders_V1 : IHeadersStructure<ArrayHeaders_V1, ArrayHeaders_V1.Enumerator>
    {
        /// <summary>
        ...
        public struct Enumerator : IEnumerator<HeaderNames>
        {
            ...
            public bool MoveNext()
            {
                ...
                {
                    var firstNonZeroByte = Helpers.TrailingZeroByteCount_Naive(remainingLongs[i]);
                ...
                if (hasInt)
                {
                    ...
                    var firstNonZeroByte = Helpers.TrailingZeroByteCount_Naive(remainingInt);
                ...
                if (hasShort)
                {
                    ...
                    var firstNonZeroByte = Helpers.TrailingZeroByteCount_Naive(remainingShort);
        ...
        public static ArrayHeaders_V1 CreateEmpty()
        => new ArrayHeaders_V1();

        public static ArrayHeaders_V1 CreateFromDictionary(Dictionary<HeaderNames, string> headers)
        {
